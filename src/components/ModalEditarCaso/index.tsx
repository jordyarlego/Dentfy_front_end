...
import { CasoData } from "../ModalNovoCasoPerito/API_NovoCaso";

interface ModalEditarCasoProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function ModalEditarCaso({
  ...
  onSubmit,
  caso,
}: ModalEditarCasoProps) {
  const [formData, setFormData] = useState<CasoData>(caso);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        console.error("Erro desconhecido ao atualizar caso:", err);
        setError("Erro inesperado ao atualizar caso.");
      }
    }
  };
